...
export class TokenEntity extends BaseEntity {
  ...
  get image(): string | undefined {
    return this.cmc
      ? `https://s2.coinmarketcap.com/static/img/coins/64x64/${this.cmc}.png`
      : undefined;
  }
}
...
export const TokenEntityDetailPopulate = [TokenEntityPlatformPopulate];

export const TokenEntityDefaultPopulateSelect = ['id', 'slug', 'cmc', 'symbol'];
